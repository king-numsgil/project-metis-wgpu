...
import { cube, plane, uvSphere } from "../src/assets/primitives";
import { createExteriorEnvironment } from "../src/scene/environment";
...
scene.add(debrisMesh, debrisMaterial, { position: vec3.create(2.2, 0.6, -1.5), rotationEuler: vec3.create(0.4, 0.9, 0.2) });
